package pl.vault.vault_server.filter;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtRequestFilter(VaultUserDetailsService vaultUserDetailsService, JwtUtil jwtUtil) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(username != null && SecurityContextHolder.getContext().getAuthentication() == null){
            UserDetails userDetails = this.vaultUserDetailsService.loadUserByUsername(username);
